...
def show_game_over(screen_sizeX, screen_sizeY, score, high_score):
	...
	message_display_center('Your Player Type : ' + str(str(classdict[int(loaded_model.predict([[coin_collected, enemy_killed, bullet_count, bullet_missed]]))])), font_medium, yellow, int(screen_sizeX/2), int(screen_sizeY *7/10))
